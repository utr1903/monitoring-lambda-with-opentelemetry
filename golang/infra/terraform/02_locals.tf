locals {
  ...
  lambda_create_function_source_dir_path = "../../apps/create/bin"
  ...
  lambda_update_function_source_dir_path = "../../apps/update/bin"
  ...
  lambda_delete_function_source_dir_path = "../../apps/delete/bin"
  ...
  lambda_check_function_source_dir_path = "../../apps/check/bin"
